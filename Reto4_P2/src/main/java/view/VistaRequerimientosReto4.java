        ...
        try {
            ...
            */ 
            for (int i=0;i<rankingProyectoCiudad.size();i++) {
                System.out.printf("%s %s %s %n", rankingProyectoCiudad.get(i).getConstructora(), rankingProyectoCiudad.get(i).getFechaInicio(), rankingProyectoCiudad.get(i).getClasificacion());
              }
